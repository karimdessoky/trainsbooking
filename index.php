...
<html lang="en">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="img/2.jpg" alt="pic 1">
      <div class="carousel-caption">
      </div>
    </div>
    <div class="item">
      <img src="img/1.jpg" alt="Pic2">
      <div class="carousel-caption">
      </div>
    </div>
       <div class="item">
  ...
  <!--End of Carousel-->
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feat buzz-out wow bounceInUp"data-wow-duration="2s" data-wow-offset="200">
                        ...
                        <h4>Responsive</h4>
                        <p>Responsive website ensure a better user experience by avoiding layout problems across mobile devices , Clear Calls to Action , the thing that responsive website design does for your business, and does well, is to help you maintain effective branding across all devices.</p>
                    </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    <div class="feat buzz-out wow bounceInDown"data-wow-duration="2s" data-wow-offset="200">
                        ...
                        <h4>Friendly</h4>
                        <p>our website is a propriate for all people , it's important purpos makes it needed and with ease of use it's available now for everyone to get benefit from it.</p>
                    </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    <div class="feat buzz-out wow bounceInRight"data-wow-duration="2s" data-wow-offset="200">
                        ...
                        <h4>Retina Ready</h4>
                        <p>Good treatment , Get Customer Feedback ,  Consistently Communicate , Highlight a Customer Experience.</p>
                    </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                    <div class="feat buzz-out wow bounceInLeft"data-wow-duration="2s" data-wow-offset="200">
                        ...
                        <p>Adjusted Columns , Flexible Fonts, Optimized Images, Judicious Use of White Space , Purpose , Visuals , Relevant original content , Clear navigation.</p>
                    </div>
                    </div>
                </div>
            </div>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
              <p class="lead">app is working fine and providing proper details. It. helping me to travel easily.</p>
            <span>Ahmed Adel</span>
        </div>
        <div class="item">
         <p class="lead">The best app. saves time and quite a bit convenient to use so far haven't faced any issues.</p>
            <span>Aya Mostafa</span>
        </div>
           <div class="item">
          <p class="lead">Fast in reporting. Also shows approx. perfect delays.</p>
               <span>Mohamed Hany</span>
        </div>
           <div class="item">
        <p class="lead">Excellent application... It's fast and provides useful and accurate data.</p>
               <span>Omar Ayman</span>
               
          </div>
              <div class="item">
        <p class="lead">It is very useful app you are many thanks.</p>
               <span>Shahenda Khaled</span>
        ...
        <div class="container">
            ...
            <div class="col-lg-3 col-sm-6 col-xs-12">
                ...
                <h2 class="text-primary">Offer#2</h2>
                    <p class="center-block">l.e40</p>
                    <ul class="list-unstyled">
                    <li>Source: Alex</li>
                    <li>Destination:Aswan</li>
                    <li>Seat:12-C</li>
                    <li>Date:2/20/2018</li>
                    <li>Time:7:10AM</li>
                    </ul>
                ...
                <h2 class="text-success">Offer#3</h2>
                    <p class="center-block">l.e70</p>
                    <ul class="list-unstyled">
                    <li>Source: Cairo</li>
                    <li>Destination:Sohag</li>
                    <li>Seat:36-T</li>
                    <li>Date:2/20/2018</li>
                    <li>Time:7:10AM</li>
                    </ul>
               ...
               <div class="col-lg-3 col-sm-6 col-xs-12">
                ...
                <h2 class="text-danger">Offer#4</h2>
                    <p class="center-block">l.e80</p>
                    <ul class="list-unstyled">
                    <li>Source: Giza</li>
                    <li>Destination: Luxor</li>
                    <li>Seat:90-Z</li>
                    <li>Date:2/20/2018</li>
                    <li>Time:7:10AM</li>
                    </ul>
    ...
    <!-- End Section Price Table -->   
        ...
        <section class="our_team text-center">
            ...
            <div class="col-lg-12 col-sm-6">
                ...
                <img class="img-circle" src="img/dessoky.png" alt="Karim Dessoky" />
                     <h3>Railway Ticket Team</h3>
                     <p>You Can Contact Us Directly By The Below Links</p>
       ...
       <!--End section stat-->
        ...
        <div class="container">
            ...
            <ul class="list-unstyled">
                ...
                <img class="img-responsive center-block wow bounceIn" src="img/img%201.png" width="126" height="28" alt="CNN" data-wow-duration=".5s" data-wow-offset="200" data-wow-delay=".5s"/>
                </li>
                <li class="col-md-2 col-xs-4">
                ...
                <li class="col-md-2 col-xs-4">
                <img class="img-responsive center-block wow bounceIn" src=img%203.png width="126" height="28" alt="CNN" data-wow-duration=".5s" data-wow-offset="200" data-wow-delay="1.5s"/>
                </li>
                <li class="col-md-2 col-xs-4">
                <img class="img-responsive center-block wow bounceIn" src="img/img%204.png" width="126" height="28" alt="CNN" data-wow-duration=".5s" data-wow-offset="200" data-wow-delay="2s"/>
                </li>
                <li class="col-md-2 col-xs-4">
